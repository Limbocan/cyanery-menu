                                  ...
                                  : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                                      ...
                                      (hasChild.value)
                                          ? (vue.openBlock(), vue.createElementBlock("svg", {
                                              key: 0,
                                              class: vue.normalizeClass(vue.unref(getClassFomat)(`col-icon ${isOpen.value ? 'open-status' : ''}`)),
  ...
  const MenuListComponent = vue.defineComponent({
      ...
      setup(props) {
          ...
          const MENU_NODE = vue.computed(() => {
              return props.menuList.map(m => vue.h(script, { data: m, diff: props.diff + 1, itemSlot: props.itemSlot }));
          });
